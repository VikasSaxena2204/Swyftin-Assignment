            ...
            <div className="relative max-w-[85%] p-3 rounded-lg bg-white shadow-lg">
              ...
              >
                <div className="relative p-1 border border-gray-500 rounded-lg mb-1">
                  <FiArrowLeft size={16} />
                  <span className="absolute inset-0 flex items-center justify-center text-xs text-gray-600 opacity-0 group-hover:opacity-100 transition-opacity bg-white p-1 rounded-md shadow-md">
                    Reply
                  </span>
                </div>
              </button>
